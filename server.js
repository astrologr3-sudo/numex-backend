...
function adminAuth(req) {
  return req.headers['x-admin-secret']===ADMIN_PASS;
}
...
app.listen(PORT, '0.0.0.0', ()=>{
  console.log('NUMEX.AI Backend running on port '+PORT);
  console.log('URL: https://numex-backend-production-aaf6.up.railway.app');
});
